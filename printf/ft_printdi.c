...
/*   Updated: 2022/02/01 00:32:23 by mcipolla         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "printf.h"

void	ft_print_direv_dot (va_list args, int len)
{
	if (params.dot == 1)
	{
...
void	ft_print_direv (va_list args, int len)
{
	if (params.dot == 0)
	{
		if (params -> plus == 1 && args >= '0'))
		...
		ft_print_direv_dot (va_list args, int len);
	params -> zero = 0;
}
